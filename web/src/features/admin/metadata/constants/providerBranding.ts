...
export const PROVIDER_BRANDING: Record<string, ProviderBranding> = {
  musicbrainz: {
    ...
    name: 'MusicBrainz',
    get description() {
      return i18n.t('admin.metadata.providerMusicBrainz');
    },
  ...
  coverartarchive: {
    ...
    get description() {
      return i18n.t('admin.metadata.providerCoverArt');
    },
  ...
  lastfm: {
    ...
    name: 'Last.fm',
    get description() {
      return i18n.t('admin.metadata.providerLastfm');
    },
  ...
  fanart: {
    ...
    name: 'Fanart.tv',
    get description() {
      return i18n.t('admin.metadata.providerFanart');
    },
  ...
  wikipedia: {
    ...
    name: 'Wikipedia',
    get description() {
      return i18n.t('admin.metadata.providerWikipedia');
    },
  ...
  'apple-touch-icon': {
    ...
    get description() {
      return i18n.t('admin.metadata.providerAppleIcon');
    },
  ...
  'google-favicon': {
    ...
    name: 'Google Favicon',
    get description() {
      return i18n.t('admin.metadata.providerGoogleFavicon');
    },
