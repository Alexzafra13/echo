...
export function ProviderStatsGrid({ providers }: ProviderStatsGridProps) {
  ...
  return (
    <div className={styles.providerStats}>
      <h4 className={styles.providerStatsTitle}>{t('admin.metadata.historyTab.byProvider')}</h4>
          ...
          return (
            ...
            >
                ...
                <div className={styles.providerNameRow}>
                  {branding ? (
                    <img
                      ...
                      style={
                        branding.statsLogoHeight ? { height: branding.statsLogoHeight } : undefined
                      }
                      onError={(e) => {
              ...
              <div className={styles.providerStatCounts}>
                <span className={styles.providerStatSuccess}>
                  {provider.success} {t('admin.metadata.historyTab.statusSuccess')}
                </span>
                <span className={styles.providerStatPartial}>
                  {provider.partial} {t('admin.metadata.historyTab.statusPartial')}
                </span>
                <span className={styles.providerStatError}>
                  {provider.error} {t('admin.metadata.historyTab.statusError')}
                </span>
              </div>
            </div>
          );
