...
export function getStatusBadge(status: string) {
  ...
  const labels = {
    success: i18next.t('admin.metadata.historyTab.badgeSuccess'),
    partial: i18next.t('admin.metadata.historyTab.badgePartial'),
    error: i18next.t('admin.metadata.historyTab.badgeError'),
  };
