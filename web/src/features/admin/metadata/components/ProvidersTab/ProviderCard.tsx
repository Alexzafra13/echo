    ...
    >
      ...
      <div className={styles.providerHeader}>
        ...
        <div className={styles.providerInfo}>
          <h4 className={styles.providerName} style={logoPath ? { display: 'none' } : undefined}>
            {name}
          </h4>
        ...
        {!requiresApiKey && (
          <span className={styles.alwaysOnBadge}>
            <Check size={14} />
            {t('admin.metadata.providersTab.active')}
          </span>
        )}
        {requiresApiKey && enabled && validationResult?.valid && (
          <span className={styles.statusBadge}>
            <Check size={14} />
            {t('admin.metadata.providersTab.configured')}
          </span>
        )}
      </div>
      ...
      {requiresApiKey && (
        <div className={styles.providerBody}>
          <Input
            ...
            placeholder={t('admin.metadata.providersTab.apiKeyPlaceholder', { name })}
          ...
          <div className={styles.providerActions}>
            ...
            >
              {isValidating
                ? t('admin.metadata.providersTab.validating')
                : t('admin.metadata.providersTab.validateApiKey')}
            </Button>
            ...
            {apiKeyUrl && (
              ...
              >
                {t('admin.metadata.providersTab.getApiKey')}
              </a>
            )}
          </div>
          ...
          {/* Validation Result */}
          {validationResult && (
            <ValidationMessage valid={validationResult.valid} message={validationResult.message} />
          )}
        </div>
      )}
    </div>
