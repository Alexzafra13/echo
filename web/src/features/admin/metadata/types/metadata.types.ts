...
export function getStorageModeLabels(): Record<StorageMode, string> {
  return {
    centralized: i18n.t('admin.metadata.storageCentralized'),
    portable: i18n.t('admin.metadata.storagePortable'),
  };
}
