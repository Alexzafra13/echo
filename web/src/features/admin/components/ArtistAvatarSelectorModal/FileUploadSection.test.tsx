...
describe('FileUploadSection', () => {
  ...
  describe('File Preview', () => {
    ...
    it('should show upload button in preview', () => {
      ...
      expect(screen.getByRole('button', { name: /aplicar selección/i })).toBeInTheDocument();
    });
  });
  ...
  describe('Upload Action', () => {
    it('should call uploadImage when upload button clicked', () => {
      ...
      fireEvent.click(screen.getByRole('button', { name: /aplicar selección/i }));
  ...
  describe('Custom Images List', () => {
    it('should render custom images section when images exist', () => {
      ...
      expect(screen.getAllByText(/subir desde/i).length).toBeGreaterThanOrEqual(1);
    });
    ...
    it('should display custom images count', () => {
      ...
      expect(screen.getByText(/subir desde.*\(2\)/i)).toBeInTheDocument();
    });
