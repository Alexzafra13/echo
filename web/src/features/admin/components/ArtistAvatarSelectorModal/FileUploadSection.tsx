...
import { AvatarImageType, CustomImage } from '../../api/artist-avatars.service';
        ...
        {!selectedFile ? (
          <div className={styles.uploadBox}>
            ...
            <label htmlFor="fileInput" className={styles.uploadLabel}>
              ...
              <p className={styles.uploadText}>{t('artists.selectArtistImage')}</p>
      ...
      {customImages.length > 0 && (
        <div className={styles.customImagesSection}>
          <h3 className={styles.sectionTitle}>
            {t('artists.uploadFromPC')} ({customImages.length})
          </h3>
...
function CustomImageCard({
  ...
  return (
    <div className={cardClassName} onClick={onSelect}>
      ...
      {image.isActive && (
        <div className={styles.activeBadge}>{t('admin.federation.statusActive')}</div>
      )}
