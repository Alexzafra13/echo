...
export const enrichmentApi = {
  ...
  async getEnrichmentStats(period?: 'today' | 'week' | 'month' | 'all'): Promise<EnrichmentStats> {
    const response = await apiClient.get<EnrichmentStats>('/admin/metadata/enrichment/stats', {
      params: { period },
    });
    return response.data;
  },
