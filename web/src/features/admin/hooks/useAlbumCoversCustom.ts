...
import { albumCoversApi } from '../api/album-covers-custom.service';
import type {
  UploadCustomCoverRequest,
  ApplyCustomCoverRequest,
  DeleteCustomCoverRequest,
} from '../api/album-covers-custom.service';
...
export function useUploadCustomCover() {
  return useMutation({
    mutationFn: (request: UploadCustomCoverRequest) => albumCoversApi.uploadCustomCover(request),
  });
}
...
export function useApplyCustomCover() {
  ...
  return useMutation({
    mutationFn: (request: ApplyCustomCoverRequest) => albumCoversApi.applyCustomCover(request),
...
export function useDeleteCustomCover() {
  ...
  return useMutation({
    mutationFn: (request: DeleteCustomCoverRequest) => albumCoversApi.deleteCustomCover(request),
