...
} from '../api/artist-avatars.service';
...
export function useApplyArtistAvatar() {
  ...
  return useMutation({
    mutationFn: (request: ApplyArtistAvatarRequest) => artistAvatarsApi.applyAvatar(request),
...
export function useUploadCustomImage() {
  ...
  return useMutation({
    mutationFn: (request: UploadCustomImageRequest) => artistAvatarsApi.uploadCustomImage(request),
    onSuccess: (_data, variables) => {
...
export function useApplyCustomImage() {
  ...
  return useMutation({
    mutationFn: (request: ApplyCustomImageRequest) => artistAvatarsApi.applyCustomImage(request),
...
export function useDeleteCustomImage() {
  ...
  return useMutation({
    mutationFn: (request: DeleteCustomImageRequest) => artistAvatarsApi.deleteCustomImage(request),
    onSuccess: (_data, variables) => {
