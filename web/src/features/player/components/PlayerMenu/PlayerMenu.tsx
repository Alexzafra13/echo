        ...
        <div className={`${styles.menuDropdown} ${closing ? styles['menuDropdown--closing'] : ''}`}>
          ...
          {volumeControlSupported && (
            <>
              ...
              >
                <span>{t('player.crossfadeBetweenSongs')}</span>
                <span
                  className={`${styles.toggleIndicator} ${crossfade.enabled ? styles['toggleIndicator--active'] : ''}`}
                />
              </button>
            </>
          )}
