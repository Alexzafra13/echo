  ...
  return (
    <div className={`${styles.miniPlayer} ${shouldShow ? styles['miniPlayer--visible'] : ''}`}>
      <div
        ...
        title={canNavigateToAlbum ? t('player.goToAlbum', { name: albumName || title }) : undefined}
      >
        <img
      ...
      {isRadioMode && (
        <div className={styles.liveIndicator}>
          ...
          <span className={styles.liveText}>{t('player.live')}</span>
        </div>
      )}

      <div className={styles.controls}>
        {!isRadioMode && (
          <button className={styles.controlBtn} onClick={playPrevious} title={t('player.previous')}>
            <SkipBack size={18} />
          </button>
        )}
        ...
        {!isRadioMode && (
          <button className={styles.controlBtn} onClick={playNext} title={t('player.next')}>
            <SkipForward size={18} />
          </button>
        )}
