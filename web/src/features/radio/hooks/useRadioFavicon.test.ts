...
// Mock the API module
vi.mock('@features/admin/api/radio-favicons.service', () => ({
  radioFaviconsApi: {
    uploadFavicon: vi.fn(),
    deleteFavicon: vi.fn(),
    autoFetch: vi.fn(),
...
import { radioFaviconsApi } from '@features/admin/api/radio-favicons.service';
...
describe('useUploadRadioFavicon', () => {
  ...
  it('debería manejar errores de upload', async () => {
    vi.mocked(radioFaviconsApi.uploadFavicon).mockRejectedValue(new Error('Upload failed'));
...
describe('useDeleteRadioFavicon', () => {
  ...
  it('debería manejar errores de delete', async () => {
    vi.mocked(radioFaviconsApi.deleteFavicon).mockRejectedValue(new Error('Not found'));
...
describe('useAutoFetchRadioFavicon', () => {
  ...
  it('debería manejar errores de auto-fetch', async () => {
    vi.mocked(radioFaviconsApi.autoFetch).mockRejectedValue(new Error('Fetch failed'));
