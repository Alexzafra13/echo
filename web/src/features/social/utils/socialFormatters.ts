...
export type SocialActionType = 'created_playlist' | 'played_track' | 'became_friends';
...
export function getActionText(actionType: string): string {
  const actionTexts: Record<string, string> = {
    created_playlist: i18next.t('social.activityCreatedPlaylist'),
    played_track: i18next.t('social.activityListened'),
    became_friends: i18next.t('social.activityBecameFriends'),
  };
