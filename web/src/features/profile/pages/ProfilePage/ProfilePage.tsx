              ...
              <div className={styles.profilePage__cardBody}>
                ...
                <div className={styles.profilePage__field}>
                  ...
                  {profileSuccess && !isEditingName && (
                    <p className={styles.profilePage__successSmall}>
                      {t('profile.nameUpdatedSuccess')}
                    </p>
                  )}
                </div>

                <div className={styles.profilePage__field}>
                  <label className={styles.profilePage__fieldLabel}>{t('profile.roleLabel')}</label>
                  <div className={styles.profilePage__fieldValue}>
                    <span
                      className={
                        user?.isAdmin
                          ? styles.profilePage__badge_admin
                          : styles.profilePage__badge_user
                      }
                    >
