 ...
 * Muestra una cuadrícula paginada de playlists basadas en géneros
 */
export function GenrePlaylistsPage() {
  ...
  const loadPlaylists = async (page: number) => {
    ...
    try {
      ...
      setError(getApiErrorMessage(err, t('recommendations.errorLoadingGenrePlaylists')));
    } finally {
      setIsLoading(false);
    }
  };
          ...
          customSearch={
            <div className={styles.genrePlaylistsPage__searchForm}>
              <div className={styles.genrePlaylistsPage__searchWrapper}>
                ...
                <input
                  type="text"
                  placeholder={t('recommendations.searchGenrePlaylists')}
                  value={searchQuery}
        ...
        <div className={styles.genrePlaylistsPage__content}>
          ...
          {isLoading && (
            <div className={styles.genrePlaylistsPage__loading}>
              ...
              <p>{t('recommendations.loadingGenrePlaylists')}</p>
            </div>
          )}
          ...
          {!isLoading && !error && playlists.length === 0 && (
            <div className={styles.genrePlaylistsPage__emptyState}>
              <Music2 size={64} />
              <h2>{t('recommendations.noGenrePlaylists')}</h2>
              <p>{t('recommendations.noGenrePlaylistsHint')}</p>
            </div>
          )}
