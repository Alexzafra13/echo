...
import type { MusicVideo } from '@features/music-videos/services/music-videos.service';
...
export type HeroItem =
  ...
  | { type: 'music-video'; data: MusicVideo & { artistId: string } };
...
/**
 * Type guard to check if HeroItem is a music video
 */
export function isHeroMusicVideo(
  item: HeroItem
): item is { type: 'music-video'; data: MusicVideo & { artistId: string } } {
  return item.type === 'music-video';
}
