...
vi.mock('@features/home/components/TrackInfoModal', () => ({
...
vi.mock('@features/home/components/TrackOptionsMenu/TrackOptionsMenu', () => ({
  TrackOptionsMenu: ({
    track,
    onAddToPlaylist,
    onAddToQueue,
    ...
    <div data-testid={`track-options-${track.id}`}>
      {onAddToPlaylist && <button onClick={() => onAddToPlaylist(track)}>Add to Playlist</button>}
...
describe('TrackList', () => {
  ...
  describe('play functionality', () => {
    ...
    it('should call togglePlayPause when clicking current track', () => {
      const mockOnTrackPlay = vi.fn();
      render(
        <TrackList tracks={mockTracks} onTrackPlay={mockOnTrackPlay} currentTrackId="track-1" />
      );
  ...
  describe('playlist reordering', () => {
    it('should render reorder buttons when onMoveUp and onMoveDown are provided', () => {
      ...
      render(<TrackList tracks={mockTracks} onMoveUp={mockMoveUp} onMoveDown={mockMoveDown} />);
  ...
  describe('current track highlighting', () => {
    it('should highlight current track', () => {
      const { container } = render(<TrackList tracks={mockTracks} currentTrackId="track-1" />);
