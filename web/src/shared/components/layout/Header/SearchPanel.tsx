          ...
          {isLoading ? (
            ...
            <div className={styles.searchPanel__results}>
              <div className={styles.searchPanel__header}>
                <h3 className={styles.searchPanel__title}>Resultados para "{searchQuery}"</h3>
              </div>
                        ...
                        >
                          ...
                          <div className={styles.searchPanel__itemInfo}>
                            ...
                            <p className={styles.searchPanel__itemMeta}>
                              {playlist.songCount}{' '}
                              {playlist.songCount === 1 ? 'canción' : 'canciones'}
                            </p>
                          </div>
                        </button>
                      ))}
            ...
            <div className={styles.searchPanel__empty}>
              <p className={styles.searchPanel__emptyTitle}>No se encontraron resultados</p>
