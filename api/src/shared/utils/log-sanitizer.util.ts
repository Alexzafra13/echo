...
const PARTIAL_REDACT_FIELDS = new Set(['email', 'username', 'user']);
...
// Query params to strip from raw URLs before logging
const SENSITIVE_URL_PARAMS = ['token', 'access_token', 'refresh_token'];
