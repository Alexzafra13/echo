...
export class BullmqService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleDestroy() {
    ...
    // Cerrar la conexión Redis (puede no existir si nunca se inicializó)
  ...
  registerProcessor(
    ...
    try {
      ...
      throw error; // Fail fast — si el worker no se puede crear, la app no debe arrancar en modo degradado
    }
  }
}
