...
export const playQueues = pgTable(
  'play_queue',
  {
    ...
    // Federation: JSON with track info when playing a federated track (mutually exclusive with currentTrackId)
    currentFederationTrack: varchar('current_federation_track', { length: 1024 }),
