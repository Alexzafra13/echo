...
@Module({
  // forwardRef en DjModule para romper la cadena circular:
  // AlbumsModule → TracksModule → DjModule → ScannerModule → AlbumsModule
  imports: [CacheModule, forwardRef(() => DjModule), MusicVideosModule],
