...
import { GetDjShuffledTracksOutput } from '../../domain/use-cases/get-dj-shuffled-tracks';
...
export class DjShuffledTrackDto {
  ...
  @ApiProperty({ nullable: true, required: false }) videoId?: string;
...
export class DjShuffledTracksResponseDto {
  ...
  @ApiProperty({
    description: 'Whether DJ-aware ordering was used (true) or fallback to random (false)',
  })
  djMode!: boolean;
