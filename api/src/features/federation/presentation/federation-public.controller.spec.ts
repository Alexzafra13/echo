...
describe('FederationPublicController', () => {
  ...
  describe('streamTrack', () => {
    it('should stream track without range header', async () => {
      ...
      (filesystemService.validateMusicPath as jest.Mock).mockReturnValue('/music/track.mp3');
      (filesystemService.createReadStream as jest.Mock).mockReturnValue(mockStream);
