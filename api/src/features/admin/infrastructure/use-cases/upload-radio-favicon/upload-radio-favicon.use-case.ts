...
import { validateFileUpload, getExtensionFromMimeType, FILE_UPLOAD_CONFIGS } from '@shared/utils';
import { UploadRadioFaviconInput, UploadRadioFaviconOutput } from './upload-radio-favicon.dto';
...
export class UploadRadioFaviconUseCase {
  ...
  async execute(input: UploadRadioFaviconInput): Promise<UploadRadioFaviconOutput> {
    ...
    validateFileUpload(input.file, FILE_UPLOAD_CONFIGS.image, input.file.buffer);
