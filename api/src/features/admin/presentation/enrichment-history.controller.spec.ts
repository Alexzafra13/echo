...
describe('EnrichmentHistoryController', () => {
  ...
  let _listEnrichmentLogsUseCase: jest.Mocked<ListEnrichmentLogsUseCase>;
  let _getEnrichmentStatsUseCase: jest.Mocked<GetEnrichmentStatsUseCase>;
  ...
  beforeEach(async () => {
    ...
    _listEnrichmentLogsUseCase = module.get(ListEnrichmentLogsUseCase);
    _getEnrichmentStatsUseCase = module.get(GetEnrichmentStatsUseCase);
  });
