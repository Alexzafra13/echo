...
export class ArtistsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los álbumes de un artista específico, ordenados por fecha de creación',
  })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  async getArtistStats(
    @Param('id', ParseUUIDPipe) artistId: string
  ): Promise<GetArtistStatsResponseDto> {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna artistas similares basado en patrones de escucha internos, con fallback a Last.fm',
  })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna la información completa de un artista específico por su identificador UUID',
  })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  @ApiOperation({
    ...
    description:
      'Busca artistas por nombre (mínimo 2 caracteres). La búsqueda es case-insensitive y busca coincidencias parciales',
  })
  @ApiParam({
    name: 'query',
    type: String,
