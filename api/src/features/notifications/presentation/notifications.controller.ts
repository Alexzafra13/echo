...
export class NotificationsController {
  ...
  async markAsRead(@Param('id') id: string, @Req() req: FastifyRequest & { user: AuthUser }) {
  ...
  async updatePreference(
    ...
    await this.notificationsService.updatePreference(req.user.id, type, body.enabled);
    return { success: true };
  }
  ...
  streamNotifications(
    ...
    const notificationStream = this.notificationEvents.getUserStream(userId).pipe(
