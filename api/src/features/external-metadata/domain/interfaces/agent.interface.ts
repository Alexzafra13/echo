...
export interface IAgent {
  ...
  /**
   * Interfaces this agent implements (e.g. ['IArtistBioRetriever', 'IArtistImageRetriever'])
   * Used by the registry to discover agents by capability without duck typing
   */
