    ...
    return {
      ...
      currentTrack: user.currentTrack
        ? {
            ...
            coverUrl: user.currentTrack.id.startsWith('federation-')
              ? user.currentTrack.coverPath
              : getCoverUrl(user.currentTrack.albumId, user.currentTrack.coverPath),
          }
        : null,
  ...
  static toActivityItemResponse(activity: ActivityItem): ActivityItemResponseDto {
    ...
    const result: ActivityItemResponseDto = {
      ...
      user: {
        ...
        avatarUrl: getAvatarUrl(
          activity.userId,
          activity.userAvatarPath,
          activity.userAvatarUpdatedAt
        ),
      },
    ...
    if (activity.actionType === 'became_friends' && activity.secondUserId) {
      result.secondUser = {
        ...
        avatarUrl: getAvatarUrl(
          activity.secondUserId,
          activity.secondUserAvatarPath || null,
          activity.secondUserAvatarUpdatedAt
        ),
      };
    }
