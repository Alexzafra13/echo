...
export class DjAnalysisMapper {
  static toDomain(raw: DjAnalysisDb): DjAnalysis {
    return DjAnalysis.fromPrimitives({
      ...
      beatgrid: raw.beatgrid ? (raw.beatgrid as number[]) : undefined,
      introEnd: raw.introEnd ?? undefined,
  ...
  static toPersistence(entity: DjAnalysis): Partial<DjAnalysisDb> {
    ...
    return {
      ...
      beatgrid: primitives.beatgrid ?? null,
      introEnd: primitives.introEnd ?? null,
      outroStart: primitives.outroStart ?? null,
