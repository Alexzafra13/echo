...
describe('PlaylistsController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: VideoEnrichmentService,
          useValue: { enrichTracksWithVideoIds: jest.fn().mockResolvedValue(undefined) },
        },
      ],
    }).compile();
  ...
  describe('getPlaylists', () => {
    it('debería retornar lista de playlists del usuario', async () => {
      ...
      // Act
      const result = await controller.getPlaylists(0, 20, false, undefined, mockRequestWithUser);
    ...
    it('debería filtrar solo playlists públicas', async () => {
      ...
      // Act
      await controller.getPlaylists(0, 20, true, undefined, mockRequestWithUser);
