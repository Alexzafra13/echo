  ...
  async searchStations(params: SearchStationsParams): Promise<RadioBrowserStation[]> {
    try {
      ...
      if (params.hidebroken !== undefined)
        queryParams.append('hidebroken', params.hidebroken.toString());
      if (params.removeDuplicates !== undefined)
        queryParams.append('removeDuplicates', params.removeDuplicates.toString());
