...
describe('RadioController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: RadioFaviconFetchService,
          useValue: { fetchAndSave: jest.fn().mockResolvedValue({ success: false }) },
        },
  ...
  describe('getTopVoted', () => {
    it('should return top voted stations', async () => {
      const mockStations = [{ name: 'Best FM' }] as unknown as RadioBrowserStation[];
