...
export class UploadAvatarUseCase {
  ...
  async execute(input: UploadAvatarInput): Promise<UploadAvatarOutput> {
    ...
    validateFileUpload(input.file, FILE_UPLOAD_CONFIGS.avatar, input.file.buffer);
    ...
    const avatarPath = await this.storageService.getUserAvatarPath(input.userId, extension);
