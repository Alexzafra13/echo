...
import { GetAlbumsByGenreInput, GetAlbumsByGenreOutput } from './get-albums-by-genre.dto';

@Injectable()
export class GetAlbumsByGenreUseCase {
  constructor(
    @Inject(GENRE_REPOSITORY)
    private readonly genreRepository: IGenreRepository
  ) {}

  async execute(input: GetAlbumsByGenreInput): Promise<GetAlbumsByGenreOutput> {
    ...
    const result = await this.genreRepository.findAlbumsByGenre({
