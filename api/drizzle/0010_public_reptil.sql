...
--> statement-breakpoint
ALTER TABLE "artists" ADD COLUMN "play_count" bigint DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "tracks" ADD COLUMN "play_count" bigint DEFAULT 0 NOT NULL;--> statement-breakpoint
