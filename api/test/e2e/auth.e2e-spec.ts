...
describe('Auth E2E', () => {
  ...
  describe('POST /api/auth/refresh', () => {
    ...
    it('debería funcionar sin Authorization header (endpoint público)', () => {
      // El endpoint de refresh es @Public(): no requiere access token en la cabecera.
      // Si lo exigiese, sería imposible renovar cuando el access token ya ha expirado.
      return request(app.getHttpServer())
        .post('/api/auth/refresh')
        .send({ refreshToken })
        .expect(200)
