...
-- Create trigram indexes on albums table for fast search
...
COMMENT ON INDEX idx_albums_title_trgm IS 'Trigram index for fast fuzzy text search on album titles';
